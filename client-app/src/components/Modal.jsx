...
const Modal = () => { 
    ...
    return (portalState.show) ? 
        (
            <div className={`${color} fixed bottom-11 text-md w-auto left-10 mx-auto flex items-center box-border align-middle text-white shadow-lg font-bold px-8 py-3`} role="alert">
